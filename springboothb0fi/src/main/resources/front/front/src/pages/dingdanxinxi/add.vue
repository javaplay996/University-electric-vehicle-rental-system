    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px"}' label="租赁日期" prop="zulinriqi">
            <el-input v-model="ruleForm.zulinriqi" 
                placeholder="租赁日期" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px"}' label="还车日期" prop="haicheriqi" >
              <el-date-picker
