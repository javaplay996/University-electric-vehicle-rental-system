<template>
	<div class="main-containers">
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(90, 180, 80, .2)","padding":"0 30px","alignItems":"center","display":"flex","justifyContent":"space-between","overflow":"hidden","top":"0","left":"0","background":"#434343","width":"100%","position":"fixed","height":"44px","zIndex":"1002"}'>
			...
			<div v-if="true" :style='{"width":"calc(100% - 370px)","margin":"0 0 0 210px","fontSize":"18px","color":"#e4e4e4","textAlign":"center"}'>基于springboot的高校电动车租赁系统</div>
			<div>
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"appFrontIcon":"cuIcon-cardboard","buttons":["新增","查看","修改","删除"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"appFrontIcon":"cuIcon-shop","buttons":["新增","查看","修改","删除"],"menu":"电动车信息","menuJump":"列表","tableName":"diandongchexinxi"}],"menu":"电动车信息管理"},{"child":[{"appFrontIcon":"cuIcon-addressbook","buttons":["查看","修改","删除"],"menu":"电动车租赁","menuJump":"列表","tableName":"diandongchezulin"}],"menu":"电动车租赁管理"},{"child":[{"appFrontIcon":"cuIcon-goodsnew","buttons":["查看","修改","删除"],"menu":"订单信息","menuJump":"列表","tableName":"dingdanxinxi"}],"menu":"订单信息管理"},{"child":[{"appFrontIcon":"cuIcon-phone","buttons":["查看","修改","删除","支付"],"menu":"电动车报修","menuJump":"列表","tableName":"diandongchebaoxiu"}],"menu":"电动车报修管理"},{"child":[{"appFrontIcon":"cuIcon-vipcard","buttons":["新增","查看","修改","删除"],"menu":"轮播图管理","tableName":"config"},{"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"租赁公告","tableName":"news"},{"appFrontIcon":"cuIcon-attentionfavor","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"appFrontIcon":"cuIcon-phone","buttons":["查看","租赁"],"menu":"电动车信息列表","menuJump":"列表","tableName":"diandongchexinxi"}],"menu":"电动车信息模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[{"child":[{"appFrontIcon":"cuIcon-shop","buttons":["查看","租赁"],"menu":"电动车信息","menuJump":"列表","tableName":"diandongchexinxi"}],"menu":"电动车信息管理"},{"child":[{"appFrontIcon":"cuIcon-addressbook","buttons":["查看","还车","报修","支付"],"menu":"电动车租赁","menuJump":"列表","tableName":"diandongchezulin"}],"menu":"电动车租赁管理"},{"child":[{"appFrontIcon":"cuIcon-goodsnew","buttons":["查看","支付"],"menu":"订单信息","menuJump":"列表","tableName":"dingdanxinxi"}],"menu":"订单信息管理"},{"child":[{"appFrontIcon":"cuIcon-phone","buttons":["查看","新增"],"menu":"电动车报修","menuJump":"列表","tableName":"diandongchebaoxiu"}],"menu":"电动车报修管理"}],"frontMenu":[{"child":[{"appFrontIcon":"cuIcon-phone","buttons":["查看","租赁"],"menu":"电动车信息列表","menuJump":"列表","tableName":"diandongchexinxi"}],"menu":"电动车信息模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
